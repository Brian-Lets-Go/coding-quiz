...
var saveHighScoreBtn = document.querySelector("#submit-button");
...
function finishQuiz() {
    ...
    var quizScoreEl = document.querySelector("#final-score");
    quizScoreEl.textContent = time;
...
saveHighScoreBtn.onclick = saveScore;
